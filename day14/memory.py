"""Day 14: Three-layer memory (Day 11–13 model + TASK_STATE + INVARIANTS)."""
...
# Structured InvariantStore JSON lives in Working Memory under this key.
INVARIANTS_KEY = "task_invariants"
